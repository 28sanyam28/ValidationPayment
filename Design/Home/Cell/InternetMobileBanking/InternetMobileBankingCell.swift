//
//  InternetMobileBankingCell.swift
//  Design
//
...
class InternetMobileBankingCell: UITableViewCell {
...
extension InternetMobileBankingCell {
    func dropdown() {
    ...
    func DefaultsData() {
        if let data = UserDefaults.standard.array(forKey: "InternetNames") as? [String] {
            self.arrNames = data
            dropdown()
        }
    }

...
class OverTheCounterCell: UITableViewCell {
...
extension OverTheCounterCell {
    ...
    func DefaultsData() {
        if let data = UserDefaults.standard.array(forKey: "overNames") as? [String] {
            self.arrNames = data
            dropdown()
        }
    }
